...
namespace MoodMe
{
    public class FaceDetector : MonoBehaviour
    {
        ...
        public static FaceDetector instance = null;
        void Awake()
        {
            if (instance == null)
        ...
        void Update()
        {
            PreviewTrackerPlane = GameObject.Find("PreviewTracker");
            ...
            if (rgba.Length == (ImageInputHeight * ImageInputWidth))
            {
                ...
                if (PreviewTrackerPlane != null)
                {
                    PreviewTrackerPlane.GetComponent<MeshRenderer>().material.mainTexture = previewTexture;
                }
